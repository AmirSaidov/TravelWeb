  ...
  en: {
    translation: {
      ...
      staysPage: {
        ...
        title: "Stays in Kyrgyzstan",
        count: "Discover {{n}} places to stay",
      },
    },
  },
  ru: {
    translation: {
      ...
      staysPage: {
        ...
        loading: "Загрузка жилья...",
        noResults: "Нет жилья по выбранным фильтрам.",
        title: "Жилье в Кыргызстане",
        count: "Найдено {{n}} вариантов жилья",
      },
    },
  },
  kg: {
    translation: {
      ...
      staysPage: {
        accommodationType: "Турактын түрү",
        hotel: "Мейманкана",
        yurtCamp: "Боз үй лагери",
        guesthouse: "Конок үйү",
        apartment: "Батир",
        pricePerNight: "Бир түндүн баасы",
        min: "Мин",
        max: "Макс",
        amenities: "Ыңгайлуулуктар",
        wifi: "Wi-Fi",
        parking: "Унаа токтотуучу жай",
        breakfastIncluded: "Эртең мененки тамак",
        kitchen: "Ашкана",
        airConditioning: "Кондиционер",
        loading: "Турактар жүктөлүүдө...",
        noResults: "Фильтрлер боюнча турак табылган жок.",
        title: "Кыргызстандагы турактар",
        count: "{{n}} турак табылды",
      },
    },
  },
};
