...
export const AuthPage = ({ mode }: Props) => {
  ...
  return (
    <AuthShell
      ...
      <button type="button" onClick={submit as any} className="flex h-11 w-full items-center justify-center gap-2 rounded-xl border border-border bg-card text-sm font-semibold transition hover:bg-muted">
